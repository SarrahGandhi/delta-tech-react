...
function ServicesPage() {
    const handleWhatsappClick = () => {
        const message = "Hello, I'd like to know more about your repair and reconditioning services.";
            ...
            <div className="services-container">
                <div className="services-menu">
                    <div className="services-menu-list">
                        <h2>Services</h2>
                        <ul>
                            <li><a href="#bearing-selection">Bearing Selection</a></li>
                    ...
                    <div className="services-whatsapp">
                        <button onClick={handleWhatsappClick}>Contact Us on Whatsapp</button>
                    </div>
                </div>
                ...
                <div className="services-list">
                    <div className="services-list-section">
                        ...
                        <div className="service-item" id="bearing-selection">
                        ...
                        <div className="service-item" id="custom-bearing-design">
                        ...
                        <div className="service-item" id="bearing-repair">
                            ...
                            <div className="levels">
                                <div className="level-1">
                                    ...
                                    <p>Initial evaluation of bearing condition to identify wear, damage, and potential failure risks before any repair action.</p>
                                    <ul>
                                ...
                                <div className="level-2">
                                    ...
                                    <p>Restoration of bearings through cleaning, minor corrections, and replacement of standard wear components to improve performance and usability.</p>
                                    <ul>
                                ...
                                <div className="level-3">
                                    <h4>Level 3: Full Remanufacturing</h4>
                                    <p>Comprehensive rebuilding process to restore bearings to near-OEM condition, ensuring long-term reliability and performance under load.</p>
                                    <ul>
                                        ...
                                        <li>Reassembly under controlled conditions with upgraded components</li>
                        ...
                        <div className="service-item" id="plant-surveys">
                        ...
                        <div className="service-item" id="installation-removal">
                    ...
                    <div className="services-list-section">
                        ...
                        <div className="service-item" id="lubrication-management">
                        ...
                        <div className="service-item" id="training-services">
                        ...
                        <div className="service-item" id="condition-monitoring">
